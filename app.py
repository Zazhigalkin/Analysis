...
import io
import numpy as np
#Потом придумать условие для нединамичных рейсов, может подтянуть колонку из отчета букингс? По типу: если отставание, то добавить другие условия проверки рейса. Или просто по названию машрута проверять, является ли рейс динамичным или нет.
